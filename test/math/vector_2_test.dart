...
void main() {
  group('Vector2', () {
    ...
    group('instance (1.0, 2.0)', () {
      final vector = new Vector2(1.0, 2.0);

      test('magnitude returns the correct value', () {
        expect(vector.magnitude, closeTo(2.23607, 0.00001));
      });

      test('unitVector returns the correct value', () {
        expect(vector.unitVector.values, orderedCloseTo([0.44721, 0.89443], 0.00001));
      });
    ...
    group('instance (0.44721, 0.89443)', () {
      final vector = new Vector2(0.44721, 0.89443);
      ...
      test('unitVector returns the correct value', () {
        expect(vector.unitVector.values,
            orderedCloseTo([0.44721, 0.89443], 0.00001));
      });
