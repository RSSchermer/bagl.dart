...
void main() {
  ...
  group('TriangleStrip', () {
    group('default constructor', () {
      ...
      group('with an index list', () {
        ...
        group('with an offset equal to the length of the index list', () {
          test('throws a RangeError', () {
            expect(() => new TriangleStrip(vertices, indices: indexList, offset: 10), throwsRangeError);
          });
        });
        ...
        group('with a valid offset and count', () {
          test('returns an instance with the correct length', () {
            expect(new TriangleStrip(vertices, indices: indexList, offset: 2, count: 6).length, equals(4));
          });
        });
      });
    });
    ...
    group('instance with an index list', () {
      ...
      final triangleStrip = new TriangleStrip(vertices, indices: indexList);
